...
let GrowwProduct_StocksDetails = document.querySelector(
  ".GrowwProduct_StocksDetails"
);
let GrowwProduct_MutualFundsDetails = document.querySelector(
  ".GrowwProduct_MutualFundsDetails"
);
let GrowwProduct_UsStocksDetails = document.querySelector(
  ".GrowwProduct_UsStocksDetails"
);
let GrowwProduct_FDsDetails = document.querySelector(
  ".GrowwProduct_FDsDetails"
);

/***change variable */
let ChangeImageAccordingNavigation = document.querySelector(
  ".ChangeImageAccordingNavigation"
);
...
GrowwProduct_StocksDetails.addEventListener("click", () => {
  ...
  stocksDetails_Text.textContent =
...
GrowwProduct_FDsDetails.addEventListener("click", () => {
  ...
  stocksDetails_Text.textContent =
    "Open fixed deposit in any bank with higher interest rates without opening a bank account.";
});
/************************************************************************************** */
